<template>
  <view>
    ...
    >
      <view class="img-box mr-3">
        <image class="order-img" :src="img" mode="aspectFill"></image>
      </view>
      <view
        class="box-right flex-col justify-between"
        :style="[{ width: titleWidth ? titleWidth + 'rpx' : '' }]"
      >
        <view class="title-text line-clamp-2" v-if="title">{{ title }}</view>
        ...
        <view class="flex">
          <view class="flex items-center">
            ...
            <view class="price-text flex items-center" v-if="score">
              <!-- <image
            ...
            <view v-if="num" class="total-text ss-flex items-center">x {{ num }}</view>
